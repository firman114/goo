  ...
  <section class="section product-detail">
    <div class="details container-md">
      ...
      <div class="right">
        ...
        <h1>Gamis’s By Zahra</h1>
        <div class="price">80k</div>
        <form>
          <div>
            <select>
        ...
        <p>Using very premium materials is not hot to use!</p>
      </div>
    </div>
  </section>
    ...
    <div class="product-center container">
      <div class="product">
        ...
        <div class="product-footer">
          <a href="#"><h3>Long Dress Muslim</h3></a>
          <div class="rating">
      ...
      <div class="product">
        ...
        <div class="product-footer">
          <a href="#"><h3>Chocolatte Dress </h3></a>
          <div class="rating">
            <i class="bx bxs-star"></i>
            <i class="bx bxs-star"></i>
            <i class="bx bxs-star"></i>
